  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Admin panel overview with fraud alerts, recent deals, and platform notifications." />
        <meta name="keywords" content="admin dashboard, dealcross, management, alerts, fraud, refund" />
