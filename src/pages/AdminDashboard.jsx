// File: src/pages/AdminDashboard.jsx import React from 'react'; import { FiAlertCircle, FiMessageSquare } from 'react-icons/fi';
...
return ( <div className="flex min-h-screen bg-[#0f172a] text-white"> {/* Sidebar */} <aside className="w-64 bg-[#1e293b] p-6 space-y-6"> <h2 className="text-2xl font-bold">Dealcross</h2> <nav className="space-y-4"> <button className="w-full text-left hover:text-blue-400">Dashboard</button> <button className="w-full text-left hover:text-blue-400">Deals</button> <button className="w-full text-left hover:text-blue-400">Users</button> <button className="w-full text-left hover:text-blue-400">Disputes</button> <button className="w-full text-left hover:text-blue-400">Settings</button> </nav> </aside>
