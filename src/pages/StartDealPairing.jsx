// File: src/pages/StartDealPairing.jsx import React, { useState } from 'react'; import { Helmet } from 'react-helmet';

const StartDealPairing = () => { const [email, setEmail] = useState(''); const [confirmed, setConfirmed] = useState(false);

const handlePairing = (e) => { e.preventDefault(); if (email) { setConfirmed(true); } };

return ( <> <Helmet> <title>Pair a Deal - Dealcross</title> <meta name="description" content="Pair your deal with a buyer or seller by entering their email or user ID." /> <meta name="keywords" content="deal pairing, escrow, connect user, dealcross" /> <meta name="author" content="Dealcross Team" /> </Helmet>
