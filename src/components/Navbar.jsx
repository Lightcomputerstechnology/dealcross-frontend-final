          ...
          <div className="fixed top-0 right-0 w-3/4 h-full bg-white dark:bg-gray-900 p-6 space-y-4 z-50">
            ...
            <div className="flex space-x-3">
              <Link
                to="/login"
                onClick={() => setOpen(false)}
                className="w-10 h-10 flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white rounded-full text-sm"
              >
                In
              </Link>
              <Link
                to="/signup"
                onClick={() => setOpen(false)}
                className="w-10 h-10 flex items-center justify-center bg-gray-800 hover:bg-gray-700 text-white rounded-full text-sm"
              >
                Up
              </Link>
            </div>
